...
export class RemoveFromCartDto {
  @ApiProperty({
    ...
    description: 'Sepetten eksiltilecek ürünün UUID kimliği',
  })
  ...
  @ApiProperty({
    ...
    description: 'Sepetten eksiltilecek ürün varyantının UUID kimliği',
  })
  ...
  @ApiProperty({
    example: 1,
    minimum: 1,
    description: 'Sepetten eksiltilecek adet (en az 1)',
  })
  @IsInt({ message: 'Adet tam sayı olmalıdır.' })
  @Min(1, { message: 'En az 1 adet eksiltilebilir.' })
  pieces!: number;
}
